  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">聊天记录 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="record" class="form-control col-md-7 col-xs-12" name="name" required="required" type="text" >
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button id="update" class="btn btn-success" onclick="addchat()">更新</button>
                        </div>
                      </div>
                  </div>
                </div>
    ...
    <script>
      ...
      function addchat(){
        ...
        var data="name="+name+"&record="+record+"&username="+username+"&password="+password;
        $.post('../api/addchatrecord.php',data,function(res){
          console.log(res);
          if(res==1){//更新成功
            ShowSuccess("添加成功..");
            setTimeout(function() {
                location.href="addchatrecord.php"
            }, 1000);
          }else{//更新失败
            ShowFailure("添加失败");
          }
