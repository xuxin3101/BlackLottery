...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">等级（0-9） <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="level" class="form-control col-md-7 col-xs-12" name="name" required="required" type="text" >
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button id="update" class="btn btn-success" onclick="update()">更新</button>
                        </div>
                      </div>
                  </div>
                </div>
    ...
    <script>
      ...
      function update(){
        var dengjiusername=$("#username").val();
        var level=$("#level").val();
        var username= localStorage.getItem("ljsscusername");
        var password= localStorage.getItem("ljsscpassword");
        var data="dengjiusername="+dengjiusername+"&level="+level+"&username="+username+"&password="+password;
        $.post('../api/updatelevel.php',data,function(res){
          console.log(res);
          if(res==1){//更新成功
            ShowSuccess("设置成功..");
            setTimeout(function() {
                location.href="shezhidengji.php"
            }, 1000);
          }else{//更新失败
            ShowFailure("设置失败");
          }
