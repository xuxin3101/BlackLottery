  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">结算令牌 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="token" class="form-control col-md-7 col-xs-12" name="name" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
    ...
    <script>
      ...
      function chongzhi(){
        ...
        var data="chongzhiusername="+chongzhiusername+"&amount="+amount+"&username="+username+"&password="+password+"&token="+token;
        $.post('../api/jiesuan.php',data,function(res){
          console.log(res);
          if(res==1){//更新成功
            ShowSuccess("结算成功..");
            setTimeout(function() {
                location.href="jiesuan.php"
            }, 1000);
          }else{//更新失败
            ShowFailure("结算失败");
          }
